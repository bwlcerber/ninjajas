  ...
  function render(container) {
    ...
    container.innerHTML = `
      ...
      <div class="dashboard-grid" style="margin-bottom: 24px; grid-template-columns: repeat(3, 1fr); gap: 14px;">
        ${statCard('68 SUCCESS CASES', stats.totalCases, 'Seeded Case Studies', 'rgba(57,144,224,0.12)', `<svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="url(#cyanTealGrad)" stroke-width="1.75" stroke-linecap="round" stroke-linejoin="round"><path d="M4 18a10 10 0 0 1 0-12m1 10a8 8 0 0 1 0-8" stroke-opacity="0.5"/><path d="M20 18a10 10 0 0 0 0-12m-1 10a8 8 0 0 0 0-8" stroke-opacity="0.5"/><polyline points="7 16 11 11 15 13 19 8" stroke-width="2"/><polyline points="10 13 12 15 15 9" stroke="#3de892" stroke-width="2"/></svg>`)}
        ${statCard('18 VISUAL CREATIVES', stats.totalCreatives, 'Gallery Media Assets', 'rgba(130,80,224,0.12)', `<svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="url(#cyanTealGrad)" stroke-width="1.75" stroke-linecap="round" stroke-linejoin="round"><rect x="2" y="4" width="20" height="16" rx="2"/><circle cx="7" cy="9" r="2" fill="url(#cyanTealGrad)"/><circle cx="13" cy="9" r="1.5" fill="#3de892"/><path d="M4 16c3-3 6 0 9-3s3-3 7 0" stroke-width="2"/><circle cx="17" cy="8" r="1" fill="#00f2fe"/><line x1="13" y1="9" x2="17" y2="8" stroke-width="0.5"/></svg>`)}
        ${statCard('12 CLIENT REFERENCES', stats.totalRefs, 'Live Showcase Sites', 'rgba(224,164,57,0.12)', `<svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="url(#cyanTealGrad)" stroke-width="1.75" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="9"/><path d="M12 3a15 15 0 0 0 0 18" stroke-opacity="0.5"/><path d="M12 3a15 15 0 0 1 0 18" stroke-opacity="0.5"/><line x1="3" y1="12" x2="21" y2="12" stroke-opacity="0.5"/><circle cx="7" cy="7" r="1" fill="#3de892"/><circle cx="17" cy="15" r="1" fill="#3de892"/><path d="M7 7c2 2 4 4 10 8" stroke-width="0.75" stroke-dasharray="2 2"/></svg>`)}
      </div>
