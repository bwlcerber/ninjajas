        ...
        <div id="case-preview-fields" style="display:none; border-top: 1px solid var(--border-subtle); padding-top:14px; margin-top:6px;">
          ...
          <div class="form-grid">
            ...
            <div class="input-group">
              ...
              <input class="input" type="text" id="case-new-services" placeholder="SEO, PPC">
            </div>
            <div class="input-group span-2">
    ...
    const modalBody = `
      <div style="display:flex; flex-direction:column; gap:14px;">
        <div class="form-grid">
          ...
          <div class="input-group">
            <span class="input-label">Services (comma-separated)</span>
            <input class="input" type="text" id="edit-case-services" value="${(mat.services_provided || []).join(', ')}">
          </div>
          <div class="input-group span-2">
            <span class="input-label">Thumbnail Image URL</span>
